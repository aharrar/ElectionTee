...
namespace WysHost
{
    class WysWrapper
    {
       ...
       public static extern bool getOtp(IntPtr outArr, int arrLength);
        ...
        [DllImport("WysLibrary", EntryPoint = "Sendrequestfordal", CallingConvention = CallingConvention.Cdecl)]
        public static extern bool Sendrequestfordal(IntPtr outArr,int outlength,int commandid);
