...
//#endif
        ...
        private void richTextBox1_TextChanged(object sender, EventArgs e)
        {
            if (Gate.flag==true)
            {
                richTextBox1.Text = "bibi - 0";
                richTextBox1.Text += Environment.NewLine+"gants - 1";
                richTextBox1.Text += Environment.NewLine + "mertz - 2";
                richTextBox1.Text += Environment.NewLine + "benet - 3";
                richTextBox1.Text += Environment.NewLine + "white - 4";
            }
            else
            {
                richTextBox1.Text = "please enter id";
            }
